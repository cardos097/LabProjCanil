        ...
        <form method="POST" action="{{ route('messages.store') }}" class="space-y-3">
            ...
            @guest
                <div>
                    ...
                    <input name="name" required class="w-full border rounded p-2" maxlength="255" />
                    @error('name')
                ...
                <div>
                    ...
                    <input name="email" type="email" required class="w-full border rounded p-2" maxlength="255" />
                    @error('email')
                        <p class="text-red-600">{{ $message }}</p>
                    @enderror
                </div>
